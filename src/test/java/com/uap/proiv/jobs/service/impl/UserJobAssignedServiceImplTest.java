...
class UserJobAssignedServiceImplTest {
    ...
    @Test
    @DisplayName("assign returns one assignment group for each job on a single user page")
    void assignsUsersToReturnedJobs() {
        ...
        when(assignedService.create(jobs, List.of(10, 20))).thenReturn(assignments);
